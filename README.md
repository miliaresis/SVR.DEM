 ...
 * Multi-(2-d) dimensional (ALOS {median}, SRTM) DEM of SE Zagros Ranges. Mendeley Data, v.4, _**http://dx.doi.org/10.17632/k9zpyh8c9k.4**_
  * Multi-(3-d) dimensional (ALOS {median}, SRTM, ASTER) DEM of SE Zagros Ranges, Mendeley Data,  v.14, _**http://dx.doi.org/10.17632/bswsr3gpy2.14**_
  * Multi-(4-d) dimensional (ALOS, SRTM, ASTER, NED)  DEM of Death Valley (CA). Mendeley Data, v.9, _**http://dx.doi.org/10.17632/fbd9pd6hnx.9**_ [_it tests the software performance with 4-d data only, (the vertical datums among  a) ALOS, SRTM, ASTER GDEM and b) NED DTM differ)_]
# Publications
