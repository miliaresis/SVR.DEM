...
# Data
  * Multi-(2.d) dimensional (ALOS median & average DEMs) of SE Zagros Ranges. Mendeley Data,  v.2, **http://dx.doi.org/10.17632/z4nxdjdyys.2** [_2-d optimization present an alternative to  DEM comparison by elevation differences modeling,that in it's general version is not limited to only 2 DEMs but can handle 3 DEMs, 4 DEMs etc. etc. It is applied to the largest study area (study area 4:data4)  of SE Zagros Ranges, to ALOS median & average DEMS, aiming to stretch the method to it's limits_] 
