...
[GeoExtent, FigureLabels, LabelHLatLonLST, LabelLST, LabelLSTxls,
 Lmin, Lmax, Rmin, Rmax, LDatadir, Tiffimporttype, cluster_method
 ] = dmr_data_headers.dataDEM2(clustering_options, tiff_import_options)
